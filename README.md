...
1. `internal-upload_v0.2.0_windows.zip`을 다운로드합니다.
...
현재 사용자용 Release asset은 `internal-upload_v0.2.0_windows.zip`입니다. GitHub가 자동으로 표시하는 `Source code (zip)` / `Source code (tar.gz)`는 소스 아카이브이며 일반 실행용 ZIP이 아닙니다.
